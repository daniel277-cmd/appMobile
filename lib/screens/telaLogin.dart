...
class telaLogin extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        '/home': (_) => const HomePage(),                   // rota da Home
      },
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      switch (e.code) {
        ...
        case 'user-not-found':    msg = 'Usuário não encontrado'; break;
        case 'wrong-password':    msg = 'Senha incorreta'; break;
      ...
      setState(() => _submitting = false);
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(content: Text('Falha inesperada. Tente novamente.')));
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) {
                          ...
                          if (!_isPasswordValid(v)) return 'Senha deve ter ao menos 8 caracteres';
                          return null;
                        },
                      ),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text('Cadastro não implementado.')),
                              );
                            },
